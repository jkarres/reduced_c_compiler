...
class Formatter {
    ...
    // many arguments
    /////////////////////////////////////////////////////////////////
    public static String toString(String template, Iterator strings) {
    ...
    public static String toString(String template, Vector strings) {
    ...
    // one argument
    /////////////////////////////////////////////////////////////////
    public static String toString(String template, Object s1) {
    ...
    // two arguments
    /////////////////////////////////////////////////////////////////
    public static String toString(String template, Object s1, Object s2) {
        Vector		strings = new Vector();
        strings.add(s1);
        strings.add(s2);
        return toString(template, strings.iterator());
    ...
    public static String toString(String template, int s1, Object s2) {
        return toString(template, Integer.toString(s1), s2);
    }

    public static String toString(String template, Object s1, int s2) {
    ...
    // three arguments
    /////////////////////////////////////////////////////////////////
    public static String toString(String template, Object s1, Object s2, Object s3) {
        Vector 		strings = new Vector();
        strings.add(s1);
        strings.add(s2);
        strings.add(s3);
    ...
    public static String toString(String template, int s1, Object s2, Object s3) {
        return toString(template, Integer.toString(s1), s2, s3);
    }

    public static String toString(String template, Object s1, int s2, Object s3) {
        return toString(template, s1, Integer.toString(s2), s3);
    }

    public static String toString(String template, Object s1, Object s2, int s3) {
        return toString(template, s1, s2, Integer.toString(s3));
    }

    public static String toString(String template, int s1, int s2, Object s3) {
        return toString(template, Integer.toString(s1), Integer.toString(s2), s3);
    }

    public static String toString(String template, int s1, Object s2, int s3) {
        return toString(template, Integer.toString(s1), s2,
                        Integer.toString(s3));
    }

    public static String toString(String template, Object s1, int s2, int s3) {
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.println(Formatter.toString("=%S=%S=%S=", System.in,
